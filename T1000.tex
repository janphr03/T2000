...
\section{Vorgehensweise bei der Softwareentwicklung}
    ...
    Nach Sommerville gehören zu den zentralen Prüfkriterien für Anforderungen die Eindeutigkeit, Konsistenz, Vollständigkeit, Realisierbarkeit und Verifizierbarkeit. 
    Diese Eigenschaften stellen sicher, dass Missverständnisse zwischen Auftraggeber und Entwicklungsteam minimiert werden, die Umsetzbarkeit gewährleistet ist 
    und Anforderungen in späteren Projektphasen überprüfbar bleiben (vgl. \cite{sommerville_software_2012}, Seite 144).
