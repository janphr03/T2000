...
\end{itemize}
    ...
    \begin{itemize}
        ...
        Schlägt der Aufbau fehl, was durch falsche Zugangsdaten, einer nicht existierenden Datenbank oder eines nicht erreichbaren Servers ausgelöst werden kann, 
        wird der Status \texttt{errorValues.ConnectionFailed} zurückgegeben. Gleichzeitig wird der Fehler im Logger dokumentiert, sodass die Ursache später nachvollziehbar bleibt. 
        Damit ist sichergestellt, dass die Anwendung reproduzierbare Statusmeldungen erhält, anstatt ungefilterte Exceptions behandeln zu müssen.
    ...
    \begin{itemize}
        \item Fehlernummer \texttt{1045} (\textit{Access Denied}): tritt auf, wenn falsche Zugangsdaten wie Benutzername oder Passwort übergeben wurden.  
        In diesem Fall wird der Status \texttt{errorValues.AuthenticationFailed} zurückgegeben.  
        ...
        \item Fehlernummer \texttt{1049} (\textit{Unknown Database}): signalisiert, dass die in der Verbindungszeichenkette angegebene Datenbank nicht existiert.  
        ...
        \item Fehlernummer \texttt{1062} (\textit{Duplicate Entry}): entsteht bei Verletzungen von Eindeutigkeits- oder Primärschlüssel-Constraints, beispielsweise beim Einfügen eines Datensatzes mit bereits existierender ID.  
