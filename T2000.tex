...
\section{Theoretischer Hintergrund}
    ...
    \subsection{Machine Learning} % 2 Seiten
        ...
        Nach der klassischen Definition von Mitchell ``a computer program is said to learn from experience~E 
        ...
        Definition von Representation Learning als Methode, die es der Maschine erlaubt, die benötigten Repräsentationen (Features) 
        automatisch aus Rohdaten zu entdecken
    ...
    \subsection{Vektor-Store}
        ...
        \subsubsection{Speicherverfahren für Vektordatenbanken}
            ...
            Die Ausführungen dienen daher der theoretischen Einordnung und sollen den technologischen Kontext verdeutlichen, in dem sich Vektordatenbanken typischerweise bewegen.
             ...
             was Skalierbarkeit, Lastverteilung und die Verwaltung großer Datenmengen erleichtert (vgl. \cite[S.~3]{ma_comprehensive_2025}).
