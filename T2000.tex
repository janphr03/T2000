...
\section{Theoretischer Hintergrund}
    ...
    \subsection{Transformer und Large Language Modelle} % 4-5 Seiten
        ...
        Moderne datengetriebene Sprachverarbeitungssysteme arbeiten nicht direkt auf symbolischen Texteingaben, 
        sondern verarbeiten ausschließlich numerische Repräsentationen. 
        Um natürliche Sprache für solche Modelle zugänglich zu machen, 
        muss der Eingabetext daher zunächst in eine geeignete mathematische Form überführt werden.
                
        Zu diesem Zweck wird der Text in einem ersten Schritt in sogenannte Tokens zerlegt. 

        
        \cite[S.~3~f.]{jurafsky_martin_slp3_2025}
